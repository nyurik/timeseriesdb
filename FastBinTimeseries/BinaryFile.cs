...
namespace NYurik.FastBinTimeseries
{
    public abstract class BinaryFile<T> : BinaryFile, IDisposable
    {
        ...
        protected BinaryFile(string fileName, IBinSerializer<T> customSerializer)
        {
            ...
            CanWrite = true;
            m_fileStream = new FileStream(fileName, FileMode.CreateNew, FileAccess.ReadWrite, FileShare.None
        ...
        protected void WriteHeader()
        {
            ...
            WriteHeaderWithVersion(memWriter, WriteCustomHeader);
            WriteHeaderWithVersion(memWriter, Serializer.WriteCustomHeader);
        ...
        /// <summary>
        /// Record file version plus custom header generated by the writeHeaderMethod
        /// </summary>
        private static void WriteHeaderWithVersion(BinaryWriter memWriter, Func<BinaryWriter, Version> writeHeaderMethod)
        {
            // Record original postition and write dummy version
            var versionPos = memWriter.BaseStream.Position;
            WriteVersion(memWriter, new Version(int.MaxValue, int.MaxValue, int.MaxValue, int.MaxValue));
            ...
            WriteVersion(memWriter, version);
        ...
        private static void WriteVersion(BinaryWriter writer, Version ver)
        {
        ...
        protected internal override sealed void Init(Type serializerType, BinaryReader memReader)
        {
            ...
            ReadCustomHeader(memReader, ReadVersion(memReader));
            Serializer.ReadCustomHeader(memReader, ReadVersion(memReader));
