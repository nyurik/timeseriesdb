...
namespace NYurik.FastBinTimeseries
{
    ...
    {
        private static readonly Version VersionMaxValue = new Version(Int32.MaxValue, Int32.MaxValue, Int32.MaxValue,
                                                                      Int32.MaxValue);
        ...
        /// <summary> Gets version and executes user provided header reader </summary>
        /// <param name="reader">Reader</param>
        /// <param name="readHeaderMethod">Method that will read custom data from the reader and check for versioning problems</param>
        /// <param name="typeMap">Type remapping information</param>
        /// <returns>Version of the custom header</returns>
        public static Version ReadCustomHeader(
            this BinaryReader reader,
            Action<BinaryReader, Version, IDictionary<string, Type>> readHeaderMethod,
            IDictionary<string, Type> typeMap)
        {
            Version version = ReadVersion(reader);
            readHeaderMethod(reader, version, typeMap);
            return version;
        }
